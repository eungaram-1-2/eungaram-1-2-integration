...
const DEFAULT_CLEANING = {
    areas: [
        ...
        { name: '음악실 쓸기', emoji: '🎵', time: '점심시간', color: '#8b5cf6' },
        { name: '음악실 닦기', emoji: '✨', time: '점심시간', color: '#ec4899' },
        { name: '칠판',          emoji: '📋', time: '방과후',   color: '#6366f1' },
        { name: '분리수거',      emoji: '♻️', time: '수요일',   color: '#22c55e' },
    ],
    schedule: {
        '교실 쓸기':     { '월': [19], '화': [17], '수': [24], '목': [32], '금': [7]  },
        '교실 닦기':     { '월': [23], '화': [26], '수': [8],  '목': [28], '금': [1]  },
        '복도 쓸기':     { '월': [18], '화': [31], '수': [2],  '목': [12], '금': [20] },
        '음악실 쓸기': { '월': [5],  '화': [],   '수': [22], '목': [],   '금': [13] },
        '음악실 닦기': { '월': [3],  '화': [],   '수': [14], '목': [],   '금': [10] },
        '칠판':          { '월': [9],  '화': [29], '수': [21], '목': [27], '금': [25] },
        '분리수거':      { '월': [],   '화': [],   '수': [30], '목': [],   '금': []   },
    }
};
